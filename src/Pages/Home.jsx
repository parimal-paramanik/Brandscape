    ...
    <div className="w-full  bg-[#E1EFFA] mt-[75px]">
      <div className="px-8 py-8">
        ...
        <div className="w-full pt-16 flex flex-col justify-center items-center">
          ...
          <h3 className="text-xl  text-gray-500 font-semibold pb-10">
          ...
          />{" "}
          <button className="relative  bottom-[82px] py-5 bg-blue-400 text-white font-semibold text-lg px-5 left-72 hover:bg-blue-500 rounded-full">
            Search AI Tools
          </button>
          <div className="flex relative bottom-12 gap-4">
            <button className="px-4 py-3 hover:underline hover:ring-offset-1 bg-white rounded-full font-medium text-gray-500">
              Marketing
            </button>
            <button className="px-4 py-3 hover:underline hover:ring-offset-1 bg-white rounded-full font-medium text-gray-500">
              Productivity
        ...
        <div className="flex justify-between item-center pb-8">
          <div className="flex gap-5 items-center">
            {filters === "featured" ? (
              <button
                className="flex justify-center text-blue-500 items-center gap-2 text-xl font-semibold py-4 px-8 border-b-4 border-blue-500"
              ...
              <button
                className="flex justify-center items-center gap-2 text-xl font-semibold py-4 px-8 border-b-4 border-gray-500"
                onClick={() => handleSubmitFilter("featured")}
              >
                <HiArrowTrendingUp />
                Featured
            ...
            {filters === "popular" ? (
              <button
                className="flex justify-center items-center gap-2 text-blue-500 text-xl font-semibold py-4 px-8 border-b-4 border-blue-500"
            ...
            {filters === "new" ? (
              <button
                className="flex justify-center items-center gap-2 text-xl font-semibold py-4 px-8 text-blue-500 border-b-4 border-blue-500"
          ...
          <div className="flex gap-5">
            <button className="flex px-4 h-12 text-lg justify-center items-center gap-2 border-2 border-gray-500 rounded-lg bg-white text-gray-900 hover:bg-gray-100">
              {" "}
              <FaAlignLeft />
              Filters
            </button>
